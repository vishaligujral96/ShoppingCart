...
for(i=0;i<grocery.length;i++){
     result+=grocery[i].name+"<br/>"+grocery[i].cat+"<br/>"+grocery[i].price+"<br/>";
}
     document.getElementById("left").innerHTML=result;*/
    /*  CreateTableFromJSON(grocery);
    
   function CreateTableFromJSON(grocery) 
           { var i;
             
            var html="<table><tr id='head'><th onclick='sort(details,0)'> Name </th><th> Category</th><th>Price</th><th>Mobile no.</th></tr>"; 
               for(i=0;i<grocery.length;i++)
               {           
                    
   
                      html+="<tr><td>"+grocery[i].name+"</td> <td>"+grocery[i].cat+"</td><td> "+grocery[i].price+"</td> <td>";
         ...
         function Search()
         {
             ...
             for(let i=0;i<vegetables.length;i++)
             {
               if((vegetables[i].name.match(reg))!=null)
               {
                   ...
                   html+="<tr><td>"+vegetables[i].name+"</td> <td>"+vegetables[i].cat+"</td><td> "+vegetables[i].price+"</td> <td> "+vegetables[i].quantity+"</td><td><input type='number' name='number'  id=quantity"+vegetables[i].cat+i+" placeholder='0'></td></tr>";
               }
             }
             for(let i=0;i<biscuits.length;i++)
             {
               if((biscuits[i].name.match(reg))!=null)
               {
                   ...
                   html+="<tr><td>"+biscuits[i].name+"</td> <td>"+biscuits[i].cat+"</td><td> "+biscuits[i].price+"</td> <td> "+biscuits[i].quantity+"</td><td><input type='number' name='number'  id=quantity"+biscuits[i].cat+i+" placeholder='0'></td></tr>";
               }
             }
             for(let i=0;i<dairy.length;i++)
             {
               if((dairy[i].name.match(reg))!=null)
               {
                   ...
                   html+="<tr><td>"+dairy[i].name+"</td> <td>"+dairy[i].cat+"</td><td> "+dairy[i].price+"</td><td> "+dairy[i].quantity+"</td><td><input type='number' name='number' id=quantity"+dairy[i].cat+i+" placeholder='0'></td></tr>";
               }
            ...
            function Add()
            {
              var table1="<table><tr><th>Name</th><th>Quantity</th></tr>";
              var qty=document.getElementById("search1").value.toLowerCase();
              var reg=new RegExp(qty,"g");
              for(var i=0;i<fruits.length;i++)
              {
                  if(fruits[i].name.toLowerCase().match(reg)==null){}else{
              ...
              {
                  if(vegetables[i].name.toLowerCase().match(reg)==null){}else{
              ...
              {
                  if(biscuits[i].name.toLowerCase().match(reg)==null){}else{
              ...
              {
                  if(dairy[i].name.toLowerCase().match(reg)==null){}else{
              ...
              table1+="</table>";
              document.getElementById("right").innerHTML=table1;
            }
